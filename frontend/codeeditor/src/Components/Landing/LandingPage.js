  ...
  return (
    <div className='landing_page'>
        ...
        <div className="landing_body flex items-center relative" style={{minHeight: "90vh"}}>
            <img className='absolute bottom-0 rotate-360' src="wave_rotate_1.svg" alt="" />
            ...
            <div className="landing_body_left w-7/12 relative">
                <div className="landing_body_left_text px-16 md:-top-0 relative h-full -top-8">
                    <h1 className='text-4xl font-bold pb-8'>Welcome to <span className='text-5xl pl-2' style={{color: "#9900ff"}}> &#123; </span>Slate <span className='text-5xl pr-2' style={{color: "#9900ff"}}>&#125;</span></h1>
                    ...
                    <div className='landing_login my-4 w-32 flex justify-center px-2 py-2 rounded-sm' style={{backgroundColor: "#9900ff"}}>
            ...
            <div className="landing_body_right w-5/12 relative">
                <img className='relative -top-10' src="vect.png" alt="" />
