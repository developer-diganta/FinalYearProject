...
function Sidebar({openSidebarVal}) {
    console.log(openSidebarVal);
    const[sidebar, setSidebar] = React.useState('path')
  return (
    <div>
        <div className="sideb w-1/5 pt-4 block md:hidden">
        ...
        <div className='hidden md:block'>
            <div className={`sidebar_mobile w-1/4 sm:w-full ${openSidebarVal === true ? 'block' : 'hidden'}`}>
                <div className="sec_1 pl-4 py-2" style={{borderBottom: "1px solid #E0E0E0"}}>
