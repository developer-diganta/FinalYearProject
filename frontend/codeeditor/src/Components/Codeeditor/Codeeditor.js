...
function Codeeditor() {
    ...
    return (
      <div className='w-full flex' style={{maxHeight: "100vh"}}>
        <div className="ce w-1/2 text-lg h-full">
          ...
          />
          <div className="footer flex justify-center gap-10 pb-3">
          ...
          {/* <LazyLoad height={200}> */}
            <div className={opScreen === false ? 'hide-op' : 'output'}>
              ...
              <div className='out p-2 font-semibold bg-gray-200 m-4'>
                <div className='in pl-4'>
                  {
                    output === '' ? 
