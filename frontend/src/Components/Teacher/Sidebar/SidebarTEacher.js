                    ...
                    </div>
                    {
                        menu.name === "courses" ? (
                            <div className={`flex flex-col text-lg font-semibold ${courseOpen ? 'block' : 'hidden'} ml-4`} style={{borderLeft: "1px solid #FFF"}}>
                                <div className='flex items-center gap-2.5 py-4' onClick={() => navigate('/teacher/previouscourse')}>
                                ...
                                <div className='flex items-center gap-2.5 py-2'>
                                    <div className='w-2 h-2 rounded-full bg-[#9900ff]'></div>
                                    <h2 className={`text-sm ${openClose ? 'block' : 'hidden'} cursor-pointer`} onClick={() => {navigate('/teacher/currentcourse')}}>Current</h2>
                                </div>
                            </div>
                        ) : (
                            <></>
