...
function UniversityLanding() {
  ...
  return (
    <div className="v min-h-screen">
        ...
        <div className='flex pt-10 relative overflow-hidden md:flex-col'>
          <div className='flex justify-center'>

            <div className='w-4/12 h-96 relative -top-8 sm:hidden md:top-0 md:w-3/4 md:overflow-hidden md:mb-8 hidden md:block'>
            ...
            <div className='w-8/12 flex flex-col justify-center pl-16 md:w-full md:px-4' style={{color: "#212529"}}>
                <h1 className='text-4xl font-semibold font-sans w-3/5 md:w-full md:pr-2 md:text-3xl sm:text-center sm:py-4'>Prepare students with better skills in a convenient way.</h1>
                ...
                <div className='flex gap-8 md:gap-4 md:w-full md:justify-center sm:my-4'>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 15l3-3m0 0l-3-3m3 3h-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            ...
            <div className='w-4/12 h-96 relative -top-8 md:hidden'>
                <div className='a a1 shadow-2xl'></div>
                <div className='a b shadow-lg'></div>
                <div className='a c shadow-lg'></div>
                {/* <div className='a d shadow-lg'></div> */}
