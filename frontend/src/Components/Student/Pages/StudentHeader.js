  ...
  return (
    <div className='flex justify-between bg-[#eaecef] py-2 px-8 items-center'>
        ...
        <div className='flex items-center gap-6'>
            ...
            <div className="profile h-10 w-10 flex justify-center items-center bg-white rounded-full cursor-pointer" style={{backgroundImage: "linear-gradient(to bottom, #fc0153, #fc0079, #ec00a5, #c500d3, #763dfe)"}}>
